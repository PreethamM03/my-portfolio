...
public class ContactsListServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    Query<Entity> query =
        Query.newEntityQueryBuilder().setKind("Person").setOrderBy(OrderBy.desc("Time")).build();
    ...
    while (results.hasNext()) {
      ...
      Person person = new Person(name, email, phoneNumber, timestamp);
      people.add(person);
    }
